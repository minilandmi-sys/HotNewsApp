...
# ===================== 自動生成社群文案 =====================
st.markdown("---")
st.subheader("✏️ 自動生成社群文案草稿 (由 Gemini 提供)")
...
if not st.session_state.df.empty:
    ...
    if st.button("✨ 生成社群文案"):
        with st.spinner("Gemini 正在撰寫文案中..."):
            try:
                model = genai.GenerativeModel("gemini-1.5-flash")  # ⚡ 免費高速版本
                prompt = f"請幫我為以下文章標題撰寫一段 Facebook 貼文文案，語氣自然、有趣、口語化並加入 emoji：\n\n標題：{selected_title}"
